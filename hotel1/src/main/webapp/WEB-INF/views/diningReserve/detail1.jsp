...
<div class="container">
	...
	<dl><dt><img alt="Location" src="${pageContext.request.contextPath}/resource/images/we.gif"> </dt><dd>
	  <span class="loc">쌍용강북교육센터 2층</span>
	...
	<p><img alt="Dinner :" src="${pageContext.request.contextPath}/resource/images/dinner.gif">
	 ...
	 <dl class="mgB0"><dt><img alt="좌석수" src="${pageContext.request.contextPath}/resource/images/zua.gif"> </dt><dd>
	  <span class="Tel">좌석40석 룸1실</span>  </dd></dl></dd></dl></dd>
        ...
        <div>
        	...
        	<div class="imgLayout">
				<ul class="slider" style="margin: 0;">
					<li><a href="#"><img src="${pageContext.request.contextPath}/resource/images/ra/la1.jpg"></a></li>
					<li><a href="#"><img src="${pageContext.request.contextPath}/resource/images/ra/la2.jpg"></a></li>
					<li><a href="#"><img src="${pageContext.request.contextPath}/resource/images/ra/la3.jpg"></a></li>
					<li><a href="#"><img src="${pageContext.request.contextPath}/resource/images/ra/la4.jpg"></a></li>
					<li><a href="#"><img src="${pageContext.request.contextPath}/resource/images/ra/la6.jpg"></a></li>
					<li><a href="#"><img src="${pageContext.request.contextPath}/resource/images/ra/la7.jpg"></a></li>
					<li><a href="#"><img src="${pageContext.request.contextPath}/resource/images/ra/lat.jpg"></a></li>
				</ul>
				<img src="${pageContext.request.contextPath}/resource/images/ra/laso.gif"  width="400">
			    <img src="${pageContext.request.contextPath}/resource/images/ra/la5.jpg"  width="400">
				<img src="${pageContext.request.contextPath}/resource/images/ra/laso2.gif"  width="400">
           </div>
