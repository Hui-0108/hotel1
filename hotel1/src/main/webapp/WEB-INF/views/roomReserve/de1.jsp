        ...
        <div style="padding-top: 30px;">
        	...
        	<div class="imgLayout">
				<ul class="slider" style="margin: 0;">
					<li><a href="#"><img src="${pageContext.request.contextPath}/resource/images/de/de1.jpg"></a></li>
					<li><a href="#"><img src="${pageContext.request.contextPath}/resource/images/de/de2.jpg"></a></li>
					<li><a href="#"><img src="${pageContext.request.contextPath}/resource/images/de/de3.jpg"></a></li>
					<li><a href="#"><img src="${pageContext.request.contextPath}/resource/images/de/de4.jpg"></a></li>
			
				</ul>
			    <img src="${pageContext.request.contextPath}/resource/images/de/deinfo.jpg"  width="400">
