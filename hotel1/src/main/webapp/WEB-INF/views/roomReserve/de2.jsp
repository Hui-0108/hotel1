        ...
        <div>
        	...
        	<div class="imgLayout">
				<ul class="slider" style="margin: 0;">
					<li><a href="#"><img src="${pageContext.request.contextPath}/resource/images/bede/bede1.jpg"></a></li>
					<li><a href="#"><img src="${pageContext.request.contextPath}/resource/images/bede/bede2.jpg"></a></li>
					<li><a href="#"><img src="${pageContext.request.contextPath}/resource/images/bede/bede3.jpg"></a></li>
					<li><a href="#"><img src="${pageContext.request.contextPath}/resource/images/bede/bede4.jpg"></a></li>
					<li><a href="#"><img src="${pageContext.request.contextPath}/resource/images/bede/bede5.jpg"></a></li>
			
				</ul>
			    <img src="${pageContext.request.contextPath}/resource/images/bede/bedeinfo.gif"  width="400">
