...
<div class="header">
    ...
    <div class="body-container" style="width: 800px;">
        <div class="body-title">
            <h3><i class="fas fa-chalkboard"></i>수페리어 스위트룸 </h3>
        </div>
        ...
        <div>
        	...
        	<div class="imgLayout">
				<ul class="slider" style="margin: 0;">
					<li><a href="#"><img src="${pageContext.request.contextPath}/resource/images/susu/ss1.jpg"></a></li>
					<li><a href="#"><img src="${pageContext.request.contextPath}/resource/images/susu/ss2.jpg"></a></li>
					<li><a href="#"><img src="${pageContext.request.contextPath}/resource/images/susu/ss3.jpg"></a></li>
					<li><a href="#"><img src="${pageContext.request.contextPath}/resource/images/susu/ss4.jpg"></a></li>
			
				</ul>
			    <img src="${pageContext.request.contextPath}/resource/images/susu/ssinfo.gif"  width="400">
