...
<div class="header">
    ...
    <div class="body-container" style="width: 100%; margin: auto;">
        <div class="body-title" style="width: 700px; margin: auto;">
            <h3><i class="fas fa-chalkboard"></i>그랜드 코너 디럭스 디럭스룸 </h3>
        </div>
        ...
        <div style="padding-top: 30px;">
        	...
        	<div class="imgLayout">
				<ul class="slider" style="margin: 0;">
					<li><a href="#"><img src="${pageContext.request.contextPath}/resource/images/grcode/grcode1.jpg"></a></li>
					<li><a href="#"><img src="${pageContext.request.contextPath}/resource/images/grcode/grcode2.jpg"></a></li>
					<li><a href="#"><img src="${pageContext.request.contextPath}/resource/images/grcode/grcode3.jpg"></a></li>
			
				</ul>
			    <img src="${pageContext.request.contextPath}/resource/images/grcode/grcodeinfo.jpg"  width="400">
